...
// tinygltf bundles its own copy of nlohmann json (3.5.0), whose include
// guard differs from the 3.9.1 subproject used elsewhere, so the two blow
// up if they meet in one translation unit. Pull in the subproject version
// first and tell tinygltf to use it.
